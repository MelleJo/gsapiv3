...
>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn(
      // Toned down: Solid dark bg, subtle border, light text - Removed hover effect
      "rounded-lg border border-slate-700 bg-slate-800/90 text-slate-100 shadow-lg backdrop-blur-sm", // Removed transition and hover:scale
      className
    )}
    {...props}
  />
